import { s as B, p as S, g as ot, b as st, f as at, e as ct, c as T, h as _t, _ as it } from "./honzo_wasm-BCeqZm0_.js";
(async ()=>{
                    ...
                    if (g) {
                        ...
                        if (b.find((u)=>u.tag === "COVR")) try {
                            const { honzo_std: u } = await ft(async ()=>{
                                const { honzo_std: R } = await import("./honzo_wasm-BCeqZm0_.js").then((L)=>L.i);
                                return {
                                    honzo_std: R
                                };
                            }, []);
